...
import { User, Eye, EyeOff, Mail, Fingerprint, Lock } from "lucide-react";
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-3 md:space-y-4">
                        ...
                        <div className="flex items-start text-xs md:text-sm">
                            ...
                            <label htmlFor="termos" className="ml-2 text-gray-700 leading-snug">
                                Eu aceito os{" "}
                                <span className="text-purple-600 hover:text-purple-800 font-medium">termos de uso</span>{" "}
                                e a{" "}
                        ...
                        <button
                            ...
                            className="w-full cursor-pointer bg-gradient-to-l from-purple-700 to-pink-600 text-white font-semibold py-2.5 md:py-3 rounded-xl shadow-md hover:shadow-lg text-sm md:text-base disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {isSubmitting ? (
                                <>
